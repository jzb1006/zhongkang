    ...
    export default {
        ...
        data(){
            return{
                ...
                //     title:'提交订单',
                // }
                // sn:'4'+(new Date()).getTime(),
            }
        },
        computed: {
            // ...mapGetters(["getLastName","getAge","getCustomizedDetail","getPhoto","getOrderSn"]),
            // params(){
            //     return {
            //         price:this.price,
            //         method:this.add_order,
            //     }
            // },
            // params1(){
            //     return {
        ...
        methods:{
            ...
            //             this.getPrice();
            //             // this.$router.push({path:'/cuspay',query:{'order_sn':sn}});
            //         }else{
            //             alert(res.data.msg);
            //         }
            //     }).catch(err=>{
            //         console.log(err);
            //     })
            //     // this.$router.push({path:'/cuspay',query:{'pay_id':this.pay_id}});
