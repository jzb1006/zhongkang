  ...
  <div id="answer">
        ...
        <div class="content">
            ...
            <div :class="{item:value.direction==1,item1:!(value.direction==1)}" v-for="(value,index) in allResult" :key="index">
                ...
                <p :class="{span_right:value.direction==1,span_left:!(value.direction==1)}">{{value.message}}</p>
            </div>
        </div>
        <div class="footer">
            ...
            <span class="zk-icon-tianjia icon tianjia" v-show="!isSend"></span>
  ...
  export default {
    ...
    methods:{
        ...
        send(){
            ...
            api.saveAdviserChat(postdata).then(res=>{
                console.log(res);
                this.text='';
