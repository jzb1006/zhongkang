<template>
  <div id="customizedOrderDetail">
        ...
        <div class="footer vux-1px-t">
            ...
            <span class="reply vux-1px" v-if="result['order_status']>=5" @click="reply(result.order_sn)">查看回复</span> -->
        ...
        <pay :show_pay_page="this.show_pay_page" @cancel="cancel" :order_sn="result.order_sn" :order_amount="this.result.order_amount" jump_url="http://192.168.0.110:8080/#/customizedOrder" subject="4" v-if="this.result.order_amount!=''"></pay>
  </div>
</template>
<script>
