|<template>
    <div id="customized">
        ...
        <div v-show="0==index">
            ...
            <div class="content vux-1px">
                ...
                <div class="item vux-1px-b">
                    ...
                    <selectAdviserLevel class="select_adviser" @getLevel="getLevel"></selectAdviserLevel>
                </div>
                <div class="item">
        ...
        <div v-show="1==index">
            ...
            <adviserList :params="params2" @selectAdviser=selectAdviser></adviserList>

        </div>

        <div v-show="2==index">
            <detailItemTem :result="params"></detailItemTem>
            <submitOrder :params="params"></submitOrder>
        </div>
...
import { TransferDom, Group, Calendar, Popup } from "vux";
    ...
    next() {
      ...
      if (this.index == 0) {
        if (this.detail == "" || this.detail == null) {
          this.alertShow = true;
          this.alertType = "warn";
          this.alertText = "请输入详细的定制需求";
          return false;
        }
        if (!this.checkLength(this.detail)) {
          this.alertShow = true;
          this.alertType = "warn";
          this.alertText = "详情字数超过限制";
          return false;
        }
        if (this.photo == "" || this.photo == null) {
          this.alertShow = true;
          this.alertType = "warn";
          this.alertText = "请至少上传一张照片";
          return false;
        }
        this.selected = [];
        // this.selected_name=[];
        ...
        if (this.age === "") {
          this.alertShow = true;
          this.alertType = "warn";
          this.alertText = "年龄不能为空";
          return false;
        }
        if (this.min === "" || this.max === "") {
          this.alertShow = true;
          this.alertType = "warn";
          this.alertText = "请填写预算区间";
          return false;
        }
        if (this.min > this.max) {
          this.alertShow = true;
          this.alertType = "warn";
          this.alertText = "预算最小值不能大于最大值";
          return false;
        }
      }
