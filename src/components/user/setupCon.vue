<template>
    <div id="setupCon">
        ...
        <user-setup-row :params="params2"></user-setup-row>
        <user-setup-row :params="params3"></user-setup-row>
...
export default {
    data(){
        return{
            // params1:{
            //     link:'/home/userSelfinfo',
            //     text:'个人信息',
            //     isShow:true,
            // },
            // params2:{
            //     link:'/home/userEditphone',
            //     text:'修改手机号',
            //     isShow:this.getUserinfo.mobile_phone!='',
            // },
            // params3:{
            //     link:'/home/userEditphone',
            //     text:'绑定手机号',
