<template>
	<div id="bill_detail_tem">
		<div class="content">
			<p class="p">
				<span class="span_left">订单金额:</span>
				<span class="span_right">{{result.money}}</span>
			</p>
			<p class="p">
				<span class="span_left">订单说明:</span>
				<span class="span_right">{{result.changedesc}}</span>
			</p>
			<p class="p">
				<span class="span_left">创建时间:</span>
				<span class="span_right">{{result.time}}</span>
			</p>
			<p class="p">
				<span class="span_left">订单号:</span>
				<span class="span_right">{{result.ordersn}}</span>
			</p>
			<p class="p">
				<span class="span_left">交易号:</span>
				<span class="span_right">{{result.tradeno}}</span>
			</p>
